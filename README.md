...
Diese Integration behebt mehrere Bugs der offiziellen Integration, verbessert die Firmware-Kompatibilität und fügt nützliche Verbesserungen hinzu. Die Kommunikation erfolgt ausschließlich über das **lokale Netzwerk** – keine Cloud erforderlich.
...
- Morgens startet der Inverter, verbindet sich ins WLAN und die Integration nimmt den normalen Betrieb automatisch wieder auf
...
### ✨ Firmware-Version als Diagnosesensor
Die Firmware-Version (`devVer`) ist jetzt als Diagnosesensor sichtbar – hilfreich um Probleme mit bestimmten Firmware-Versionen zu korrelieren.
